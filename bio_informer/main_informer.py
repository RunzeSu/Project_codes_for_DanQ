...
parser.add_argument('--seq_len', type=int, default=1000, help='input sequence length of Informer encoder')
parser.add_argument('--label_len', type=int, default=1000, help='start token length of Informer decoder')
parser.add_argument('--pred_len', type=int, default=919, help='prediction sequence length')
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_{}'.format(args.model, args.features, 
